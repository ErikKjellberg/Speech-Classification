# This script runs a tf-idf model. It is used as a baseline to compare the other models to.
...
if firsttime:
    ...
    if loadjson:
            ...
            for file in os.listdir(data_dir):
                if file.endswith(".json"):
                    ...
                    with open(data_dir+file,"r",encoding="utf-8-sig") as f:
                        ...
                        # If it is a party who has spoken, use the speech
        ...
        speeches, parties, year_indices = torch.load("data_"+str(start_year)+"_"+str(end_year)+".pt")
